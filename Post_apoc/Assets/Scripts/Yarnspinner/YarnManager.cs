...
namespace Yarn.Unity.Example {
	...
	/// </summary>
    public class Yarnmanger : DialogueViewBase
    {
		[SerializeField] DialogueRunner runner;

		[Header("Assets"), Tooltip("you can manually assign various assets here if you don't want to use /Resources/ folder")]
		private List<Sprite> loadSprites = new List<Sprite>();
		private List<AudioClip> loadAudio = new List<AudioClip>();
...
>>>>>>> Stashed changes
		...
		T FetchAsset<T>( string assetName ) where T : UnityEngine.Object {
		    ...
		    if ( useResourcesFolders ) {var newAsset = Resources.Load<T>(assetName); if ( newAsset != null )
			{return newAsset;
			}
			}
